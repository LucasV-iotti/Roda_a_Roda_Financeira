...
const PUZZLES = [
  ...
  { categoria: 'Financeira	Dica: Garantia menor que a dívida. Nave depreciada!', frase: 'DESEMPREGADO' },
  { categoria: 'Financeira	Dica: Renda flutuante. Profissional liberal em missão solo.', frase: 'SUPER ENDIVIDADO' },
  { categoria: 'Financeira	Dica: Investimentos maiores que a parcela. Cliente estrela do banco.', frase: 'BEM DEPRECIADO' },
